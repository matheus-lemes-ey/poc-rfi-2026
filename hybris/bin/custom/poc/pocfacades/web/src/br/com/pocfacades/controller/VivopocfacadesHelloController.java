 ...
 */
package br.com.pocfacades.controller;
...
@Controller
public class PocfacadesHelloController
{
	@Autowired
	...
	{
		model.addAttribute("logoUrl", pocfacadesService.getHybrisLogoUrl(PLATFORM_LOGO_CODE));
		return "welcome";
	}
}
